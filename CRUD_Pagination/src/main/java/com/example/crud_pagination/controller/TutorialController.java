package com.example.crud_pagination.controller;

import com.example.crud_pagination.entity.Tutorial;
import com.example.crud_pagination.repository.TutorialRepository;
...
public class TutorialController {
    ...
    public String editTutorial(@PathVariable("id") Integer id, Model model, RedirectAttributes redirectAttributes) {
        try {
            ...
            model.addAttribute("tutorial", tutorial);
            model.addAttribute("pageTile", "Edit Tutorial (ID: " + id + ")");
    ...
    public String updateTutorialPublishedStatus(@PathVariable("id") Integer id, @PathVariable("status") boolean published,
        ...
        try {
            ...
            String status = published ? "published" : "disable";
